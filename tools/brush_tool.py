...
class BrushTool:
    ...
    def _redraw_brush(self):
        ...
        opacity_surface = pygame.Surface((self.brush_size + padding,
                                          self.brush_size + padding),
                                         flags=pygame.SRCALPHA,
                                         depth=32)
        opacity_surface.fill(pygame.Color(255,255,255,self.opacity))

        self.image.blit(opacity_surface, (0, 0), special_flags=pygame.BLEND_RGBA_MULT)
